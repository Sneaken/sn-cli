...
// It also supports all forms of socket communication from low level unix and windows sockets to UDP and secure TLS and TCP sockets.
// dont support require when node-ipc > 10
const ipc = require('node-ipc')

const DEFAULT_ID = process.env.SN_CLI_IPC || 'SN-cli'
...
const PROJECT_ID = process.env.SN_CLI_PROJECT_ID
